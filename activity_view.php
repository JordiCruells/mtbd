...
<?php /*           
      ...
      <div class="row text-center">
          <button class="btn btn-primary btn-modify" type="button" data-link="activity_form.php?id=<?php echo $id; ?>&action=update" >Modificar</span></button>
          <button class="btn btn-primary" type="button">Imprimir</span></button>
          <button class="btn btn-info btn-back" type="button" data-link="activity_list.php">Tornar</span></button>
      </div>
