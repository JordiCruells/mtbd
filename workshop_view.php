    ...
    <div class="col-xs-12 view-page">
     ...
     <h3>Resum</h3> 
      ...
      <div class="row text-center">
          <button class="btn btn-primary btn-modify" type="button" data-link="workshop_form.php?id=<?php echo $id; ?>&action=update" >Modificar</span></button>
          <button class="btn btn-primary" type="button">Imprimir</span></button>
          <button class="btn btn-info btn-back" type="button" data-link="workshop_list.php">Tornar</span></button>
      </div>
